...
// import { useAllExampleQuery, useOneExampleQuery } from 'services/ExampleQuery'

import { routes } from 'utils/routes'

const Home = () => {
  // const { data: all } = useAllExampleQuery()
  // const { data: one } = useOneExampleQuery({ id: '17' })
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <button className="bg-white text-black mx-auto my-12" onClick={() => signOut()}>
        Sign out
      </button>

      <Link href={routes.AdminHome.path}>
        <button className="bg-white text-black mx-auto my-12">Ir a plataforma</button>
      </Link>
